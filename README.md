...
Custom firmware fork of [`unfoldedcircle/remote-ui`](https://github.com/unfoldedcircle/remote-ui) for the **Unfolded Circle Remote 3**, replacing the stock analog-clock charging screen with a GPU-accelerated screensaver system. **Custom firmware. Voids the warranty.**
...
**UI chrome beyond the screensaver (v1.3.0 → v1.4.26):**
...
curl -L -O https://github.com/mmadalone/Madalones-Defolded-Circle-3/releases/download/v1.4.36/remote-ui-v1.4.36-UCR3-static.tar.gz
...
./scripts/verify-release.sh remote-ui-v1.4.36-UCR3-static.tar.gz remote-ui.hash
...
curl --location "http://${UC3_HOST}/api/system/install/ui?void_warranty=yes" \
    --form "file=@remote-ui-v1.4.36-UCR3-static.tar.gz" \
    -u "web-configurator:${UC3_PIN}"
```
...
./scripts/verify-release.sh \
    remote-ui-v1.4.36-UCR3-static.tar.gz \
    remote-ui.hash \
    remote-ui-v1.4.36-UCR3-static.tar.gz.asc
```
